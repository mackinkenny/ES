...
<div class="text-center">
    <h1 class="m-5" style="font-size: 30px; font-weight: bold;">Создать товар</h1>
</div>
<div class="row col-md-12 col-md-offset-1 justify-content-center ">
    <form class="forma p-4" action="{{ route('storeother') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
