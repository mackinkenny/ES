...
<div class="row col-md-12 col-md-offset-1 justify-content-center ">
    <form class="forma p-4" action="{{ route('storetype') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="mt-2"><label class="create-label" for="name">Название типа*</label><input type="text" name="name" style="float:right;"></div><hr>
        <div class="mt-2"><label class="create-label" for="category_id">Категория*</label><select name="parent_id" class="js-example-basic-single" style="float:right;">
