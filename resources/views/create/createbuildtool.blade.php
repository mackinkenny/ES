...
<div class="text-center">
    <h1 class="m-5" style="font-size: 30px; font-weight: bold;">Создать Стройинструменты</h1>
</div>
<div class="row col-md-12 col-md-offset-1 justify-content-center ">
    <form class="forma p-4" action="{{ route('storebuildtool') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
