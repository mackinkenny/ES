...
<div class="text-center">
    <h1 class="m-5" style="font-size: 30px; font-weight: bold;">Создать Стройматериалы</h1>
</div>
<div class="row col-md-12 col-md-offset-1 justify-content-center ">
    <form class="forma p-4" action="{{ route('storebuildmaterial') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="mt-2"><label class="create-label" for="type_id">Категория*</label><select name="type_id" class="js-example-basic-single" style="float:right;">
