...
<div class="text-center">
    <h1 class="m-5" style="font-size: 30px; font-weight: bold;">Создать тип инструментов</h1>
</div>
<div class="row col-md-12 col-md-offset-1 justify-content-center ">
    <form class="forma p-4" action="{{ route('storetooltype') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
