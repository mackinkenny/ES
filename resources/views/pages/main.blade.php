...
<div class="container">
    ...
    <div class="row col-12 justify-content-center mt-5">
            ...
            <div class="row col-md-5 p-md-4 p-2 mb-2 mr-md-5 ml-3" style="background:#f9f9f9;">
                @if($product->img_path != null)
                <div class="col-md-4 col-3 text-script">
                ...
                <div class="col-8 text-script">
                    <div class="col-12 text-script">
                        <a href="/showproduct/{{$product->id}}" class="main-text ml-md-3"><?= str_limit($product->name, 30) ?></a>
                    </div><br>
                    <div class="col-12 text-script">

                        <span class="ml-md-3 mr-md-5 mr-4">{{$product->parent_name}}</span>

                        <span>{{$product->created_at}}</span>
                    </div><br>
                    <div class="col-12 ml-md-3 text-script">
                    ...
                    @else
                        ...
                        <div class="col-12 text-script">
                            ...
                            <span class="ml-md-3 mr-5">{{$product->parent_name}}</span>

                            <span class="mr-5">{{$product->created_at}}</span>
                        </div><br>
                        <div class="col-12 ml-md-3 mt-2 text-script">
                            <span><?= str_limit($product->info, 80) ?></span>
                        </div>
                @endif
